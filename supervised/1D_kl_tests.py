...
if N ==1:
    ...
    p_train_data = torch.cos(2*train_data)
...
q_params_nn = q_phi_ff_connected(Nin,Nhid,Nout,num_layers)
...
for t in tqdm(range(n_epochs)):
    ...
    if t == n_epochs-1 or (t+1) % leap == 0:
        ...
        if show_periodic_plots and N==1:
            ...
            pred_q,pred_gamma,pred_mu,pred_sigma,mus_max_idx = q_params_nn(p_train_data,x_test)
            loss_plot_testos(x_axis,loss_list,I.item(),adaptive_factor,x_test,mus_max_idx.detach())
